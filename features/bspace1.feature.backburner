...
Scenario: student clicks on the assignments+projects link
	Given I am a student of the "Computer Science 169" course
	When I click on the assignments+projects link on the "Computer Science 169" course page
	Then I am directed to the Student's version of the "Computer Science 169" assignemnts+projects page

Scenario: student clicks on the exams+quizzes link
	Given I am a student of the "Computer Science 169" course
	When I click on the exams+quizzes link on the "Computer Science 169" course page
	Then I am directed to the Student's version of the "Computer Science 169" exams+quizzes page
